...
def test_model(input_shape):
    ...
    x2 = layers.Conv2D(64, (5, 5), activation='relu', padding='same')(inputs)
    x2 = layers.Dropout(.05)(x2)
    ...
    x3 = layers.Conv2D(64, (7, 7), activation='relu', padding='same')(inputs)
    x3 = layers.Dropout(.05)(x3)
    ...
    fc = layers.Dense(48, activation='relu')(fc)
